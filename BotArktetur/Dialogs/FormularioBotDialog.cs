...
{
    [Serializable]
    public class FormularioBotDialog : IDialog<IMessageActivity>
    {
        ...
        private async Task CarregaTextoSobre(IDialogContext context)
        {
            ...
            await context.PostAsyncDelay(botBody.SobreEmpresa);
            await Task.Delay(800);
            await context.PostAsyncDelay(botBody.OpcoesVoltar);
